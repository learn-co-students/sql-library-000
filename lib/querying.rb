...
def select_character_names_and_number_of_books_they_are_in
	'SELECT characters.name, COUNT(books.title) AS titles FROM character_books JOIN characters ON character_books.character_id = characters.id JOIN books ON character_books.book_id = books.id GROUP BY characters.name ORDER BY titles DESC'
end
